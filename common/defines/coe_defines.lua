NDefines.NGame.START_DATE = "1010.1.1.12"
NDefines.NGame.END_DATE = "1020.1.1.1"
NDefines.NGame.FUEL_RESOURCE = "magic"
NDefines.NGame.HANDS_OFF_START_TAG = "YAK"
...
NDefines.NDiplomacy.TENSION_TIME_SCALE_START_DATE = "1010.1.1.12"
NDefines.NDiplomacy.TENSION_PUPPET = 0.5
...
NDefines.NCountry.POPULATION_YEARLY_GROWTH_BASE = 0.025
...
NDefines.NCountry.MIN_MAJOR_COUNTRIES = 5
NDefines.NCountry.ADDITIONAL_MAJOR_COUNTRIES_IC_RATIO = 0.6
NDefines.NCountry.PARADROP_AIR_SUPERIORITY_RATIO = 0.6
NDefines.NCountry.AUTONOMOUS_SPILLOVER = 0.05
NDefines.NCountry.UNCAPITULATE_LEVEL = 0.2
...
NDefines.NCountry.BASE_FUEL_GAIN_PER_OIL = 2
NDefines.NCountry.BASE_FUEL_GAIN = 2
NDefines.NCountry.BASE_FUEL_CAPACITY = 50000
